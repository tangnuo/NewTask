package com.kedacom.module_lib.imageloader.glide;
...
import com.kedacom.module_lib.imageloader.IImageLoader;
...
public class GlideImpl implements IImageLoader {
    ...
    public void load(ImageView imageView, String url) {
        ...
        RequestOptions options = new RequestOptions()
                .centerCrop()
//                .fitCenter()
                .placeholder(R.mipmap.icon_server)
                .error(R.mipmap.icon_server)
