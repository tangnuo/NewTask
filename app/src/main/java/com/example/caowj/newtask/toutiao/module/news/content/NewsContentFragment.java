...
import com.example.caowj.newtask.toutiao.module.base.BaseFragment;
...
public class NewsContentFragment extends BaseFragment<INewsContent.Presenter> implements INewsContent.View {
    ...
    protected void initData() {
        ...
        if (isHasImage) {
            GlideUtil.loadCenterCrop(getActivity(), mBundle.getString(IMG), imageView, R.mipmap.error_image, R.mipmap.error_image);
