...
public class PaiPinBean {
    ...
    private int ActualEndTim;

    private String PicCarousel;

    private String PicFixedPrice;

    private String PicDetails;

    private String PicMainTomorrow;
    ...
    public int getRetain_price() {
        return Retain_price;
    }

    public void setRetain_price(int retain_price) {
    ...
    public int getActualEndTim() {
        return ActualEndTim;
    }

    public void setActualEndTim(int actualEndTim) {
    ...
    public void setYkj_pic(String ykj_pic) {
        this.ykj_pic = ykj_pic;
    }
    ...
    public int getKuaidiMoney() {
        return kuaidiMoney;
    }

    public void setKuaidiMoney(int kuaidiMoney) {
    ...
    public void setPaipinPP(String paipinPP) {
        this.paipinPP = paipinPP;
    }
