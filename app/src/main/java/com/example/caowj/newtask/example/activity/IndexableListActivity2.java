...
public class IndexableListActivity2 extends AppCompatActivity {
    ...
    private WordsNavigation iwMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indexable_list2);
        initData();//初始化数据
        initview();//初始化布局
    }
    ...
    private void initview() {
        ...
        iwMain = ((WordsNavigation) findViewById(R.id.iw_main));
...
//                super.onScrolled(recyclerView, dx, dy);
                ...
                LogUtil.myD("dx:" + dx + ",dy:" + dy);
                //当滑动列表的时候，更新右侧字母列表的选中状态
//                iwMain.setTouchIndex(persons.get(dx).getHeaderWord());
            }
        });
        setTvWord();
    }
    ...
    private void setTvWord() {
        iwMain.setOnWordsChangeListener(new WordsNavigation.onWordsChangeListener() {
            @Override
