...
/**
 * Glide的配置类<br/>
 * 参考：http://mrfu.me/2016/02/27/Glide_Getting_Started/<br/>
...
public class GlideLoadConfig {
    ...
    private LoadPriority prioriy;//优先级
    ...
    private GlideLoadConfig(GlideLoadConfig.Builder builder) {
    ...
    public static Builder parseBuilder(GlideLoadConfig config) {
