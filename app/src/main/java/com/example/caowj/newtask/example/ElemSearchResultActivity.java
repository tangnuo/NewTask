...
public class ElemSearchResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elem_search_result);
    ...
    private void performEnterAnimation() {
        ...
        alphaVa.setDuration(100);
        alphaVa2.setDuration(100);
        translateVa.setDuration(100);
        scaleVa.setDuration(100);
